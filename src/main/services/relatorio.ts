...
export async function gerarRelatorio(db: DB, filtros: FiltrosBusca, caminho: string): Promise<number> {
  ...
  resumo.addRow([
    ...
    'Mínimo', 'Mediana', 'Máximo', 'Vencedor médio', 'Teto ref.', 'Acima teto', 'Última data'
  ]).font = { bold: true }
